...
const DICT: Record<string, { en: string; ru: string }> = {
  ...
  "detail.fuel": { en: "Fuel & economy", ru: "Топливо и расход" },
  "detail.days": { en: "d", ru: " дн" },
  "detail.fuelLevel": { en: "Fuel level", ru: "Уровень топлива" },
  "detail.fuelRemaining": { en: "Remaining", ru: "Остаток" },
  "detail.fuelMpg": { en: "Efficiency", ru: "Эффективность" },
  "detail.fuelUsed": { en: "Fuel used", ru: "Израсходовано" },
  "detail.fuelCost": { en: "Est. fuel cost", ru: "Оценка затрат" },
  "detail.fuelDistance": { en: "Distance", ru: "Пробег" },
  "detail.fuelIdle": { en: "Idle time", ru: "Простой (х.х.)" },
